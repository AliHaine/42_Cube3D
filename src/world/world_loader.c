...
void	world_loader(t_core *core)
{
	...
	world_creator(WORLD_END, world_get_biomes(2, get_biome(BIOME_END), get_biome(BIOME_CHORUS)), get_sound(END_AMBIANT_SOUND), 32, 32, (uint32_t []){0, 0}, core->imgs.skybox_nether, get_block_image(BLOCK_END_STONE), NORMAL, false, true);
