...
void	biome_loader(void)
{
	...
	set_biome(biome_creator(2, BLOCK_END_STONE_BRICKS, BLOCK_END_STONE), BIOME_END);
	set_biome(biome_creator(3, BLOCK_CHORUS_FLOWER, BLOCK_CHORUS_FLOWER_DEAD, BLOCK_CHORUS_PLANT), BIOME_CHORUS);
}
