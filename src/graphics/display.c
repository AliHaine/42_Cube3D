...
void	display(void *params)
{
	...
	raycasting(&core->player, &core->imgs, &core->maps[get_active_world(core->maps)], core->blocks);
	minimap_drawing(&core->imgs, core->player.player_pos_xy, &core->maps[get_active_world(core->maps)]);
